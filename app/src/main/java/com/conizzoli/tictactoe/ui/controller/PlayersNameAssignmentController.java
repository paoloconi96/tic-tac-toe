...
public class PlayersNameAssignmentController {
    ...
    @Inject
    public PlayersNameAssignmentController(PlayerService playerService, ResourceBundle resourceBundle, BufferedReader bufferedReader) {
    ...
    private void updateNameFor(Player player, EnumMap<Player, String> playerNamesMap) throws IOException {
        System.out.println(MessageFormat.format(
